        ...
        <form class="form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.blog.store') }}" id="blog-form">
            ...
            <div class="wg-box">
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter blog title" name="title" id="blog-title" value="{{ old('title') }}" aria-required="true" required>
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="number" placeholder="Enter blog read time in minutes" name="read_time" id="blog-read-time" value="{{ old('read_time') }}" aria-required="true" required>
