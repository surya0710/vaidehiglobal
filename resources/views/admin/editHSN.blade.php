...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            ...
            <form action="{{ route('admin.hsn.edit', $hsn->id) }}" method="POST" class="form-new-product">
                @csrf

                <div class="form-group" style="margin-bottom: 15px;">
                    <fieldset class="name">
                        <label class="body-title">HSN Category <span class="tf-color-1">*</span></label>
                        <input type="text" name="hsn_category" value="{{ old('hsn_category', $hsn->hsn_category) }}" required>
                    </fieldset>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    <fieldset class="hsn_code">
                        ...
                        <input type="text" name="hsn_code" value="{{ old('hsn_code', $hsn->hsn_code) }}" required>
                    </fieldset>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    <fieldset class="hsn_description">
                        ...
                        <input type="text" name="hsn_description" value="{{ old('hsn_description', $hsn->hsn_description) }}" required>
                    </fieldset>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    <fieldset class="chapter">
                        ...
                        <input type="number" name="chapter" value="{{ old('chapter', $hsn->chapter) }}" required>
                    </fieldset>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    <fieldset class="url">
                        ...
                        <input type="text" name="url" value="{{ old('url', $hsn->url) }}">
                    </fieldset>
                </div>

                <div class="bot">
                    <button class="tf-button w208" type="submit">
                        <i class="icon-save"></i> Edit HSN
                    </button>
                </div>
